    ...
    <div key={i} className='movieCard'>
      ...
      <Card className='movieObjectContain' key={i}>
        ...
        <div className="queueButtonContain">
          ...
          {
            this.props.marqueeFilm.length === 0 ? <Button variant="contained" color='primary' className='queueMarqueeButton' onClick={() => this.props.addToMarquee(i)}>marquee</Button> : null
          }
        </div>
      </Card>
    </div>
